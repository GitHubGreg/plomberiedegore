          ...
          <div className="flex items-center lg:gap-2 xl:gap-5">
            <Popover className="lg:hidden">
              {({ open, close }) => (
                <>
                  <PopoverButton
                    className="relative z-10 -m-2 inline-flex items-center rounded-lg stroke-gray-900 p-2 transition-all hover:bg-gray-200/50 hover:stroke-gray-600 active:stroke-gray-900 ui-not-focus-visible:outline-none"
